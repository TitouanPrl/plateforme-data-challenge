    ...
    <article>
      <!-- INSCRIPTION D'un utilisateur -->
        ...
        <form action="validInsc.php" method="POST">
          <div style="display:flex; justify-content:center;align-items:center;flex-direction:column;padding-top:70px;">
            <div id="formAdmin" >
              <h2 style="padding-bottom:20px;">Inscription utilisateur</h2>
              <div id="formfunction">
                <fieldset class="boutonsRadio">
                    <legend>
